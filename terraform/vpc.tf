...
# Private Database Subnets (RDS MySQL)
...
# Private DB Route Table Association (DB subnets can use private route tables or remain isolated)
...
# VPC Endpoint for S3 (Gateway Endpoint, free of charge and optimizes S3 access from private subnets)
